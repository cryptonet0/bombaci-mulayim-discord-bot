...
client.on('message', msg => {
  if (msg.content === 'help') {
    msg.reply("photo parrot = Papağan resmi, photo cat = Kedi resmi, photo duck = Ördek resmi, photo bird = Kuş resmi, photo dog = Köpek resmi, photo wolf = Kurt resmi, video cat = Kedi videosu, photo fox = Tilki resmi, JavaPause = Durdurma resmi, photo jaguar = Jaguar resmi, Selamünaleyküm = Aleykümselam, photo chicken = Tavuk resmi, photo puppy = Köpek resmi, photo turtle = Kaplumbağa resmi, photo squid = -, photo panda = Panda resmi, photo lion = Aslan resmi, photo cow = İnek resmi,");
  }
  
  });

client.on('message', msg => {
  if (msg.content === 'nihat hatipoğlu') {
    msg.reply("https://www.youtube.com/watch?v=jjFBaksxX6Q");
    msg.reply("https://www.youtube.com/watch?v=4pXOLu2KcFU");
    msg.reply("https://www.youtube.com/watch?v=BxUb3pYPAYM");
  }
...
client.on('message', msg => {
  if (msg.content === 'poşetguy') {
    msg.reply('https://www.youtube.com/watch?v=r2U7B2PRG50');
  }
    
});
  client.on('message', msg => {
  if (msg.content === 'ibolipa') {
    msg.reply('https://www.youtube.com/watch?v=XEQwcMiSdrU');
  }
    });
  client.on('message', msg => {
  if (msg.content === 'dom dom kurşunu') {
    msg.reply('https://www.youtube.com/watch?v=sPzP8Mbbcf8');
  }
});
...
client.on('message', msg => {
  ...
  if (msg.content === 'Hayırlı Ramazanlar') {
    msg.reply('Sanada Kardeşim');
  }
  if (msg.content === 'HEHE BOI') {
    msg.reply('https://steamuserimages-a.akamaihd.net/ugc/939436531242406815/5661A4FD441E9BF9D6EB29644E3EFEB545BE648C/');
  }
   if (msg.content === 'Killjoy') {
    msg.reply('https://i.ytimg.com/vi/cGMwIXuOCH4/maxresdefault.jpg');
  }
  if (msg.content === 'Harmanım, baba nerde çarşafım?') {
    msg.reply('https://www.youtube.com/watch?v=2igqlDx_iBw');
    msg.reply('https://www.youtube.com/watch?v=AqwTVvVvOLs');
    msg.reply('https://www.youtube.com/watch?v=s1_49UhZq-A');
    msg.reply('https://youtube.com/watch?v=s9uC0cTK06o&feature=share');
  }
  if (msg.content === 'AJDARIMM') {
    msg.reply('https://dbq8hrmshvuto.cloudfront.net/assets/132/906/105/normal/20120815101030_default.jpg');
    msg.reply('https://www.youtube.com/watch?v=wvQDIL5BrBY');
  }
  if (msg.content === 'meme') {
    msg.reply('https://youtube.com/watch?v=RUpOpAKRlJg&feature=share');
    
    msg.reply('https://i.redd.it/yrpv7yblwhr41.jpg');
    msg.reply('https://i.pinimg.com/564x/9a/15/0f/9a150f84de8af153098f6af693d730cd.jpg');
    msg.reply('https://www.kiss.ie/app/uploads/2020/05/my-plans-vs-2020-meme-01-5ec7e306c35c7__700.jpg');
    msg.reply('https://i.redd.it/yrpv7yblwhr41.jpg');
    msg.reply('https://cdn.kinsights.com/cache/82/51/825185b61ee204ce35a5aa9495c73adf.jpg');
  }
...
client.login('Nzc5NzMyMzg2MDU2MzcyMjI0.X7k0Xw.yGR3_V3UqTDKIDkcDk7isLQTOas');
